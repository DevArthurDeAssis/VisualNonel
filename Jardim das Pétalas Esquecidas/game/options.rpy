...
define config.name = _("Jardim das Pétalas Esquecidas")
...
define build.name = "JardimdasLagrimasdeJasmin"
...
define config.save_directory = "JardimdasLagrimasdeJasmin-1719188066"
